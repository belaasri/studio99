    ...
    <div className="flex min-h-screen w-full flex-col bg-gray-50">
      <header className="flex h-16 w-full items-center justify-between border-b bg-white px-4 md:px-8">
        <div className="flex items-center gap-2">
          <YoutubeIcon />
          <span className="text-xl font-bold">VideoDown</span>
        </div>
      ...
      <main className="flex flex-1 flex-col items-center p-4 text-center md:p-6">
        <section className="w-full max-w-4xl py-12 md:py-20">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-600">
            Paste any YouTube URL to instantly download the video. No signup, no ads, 100% free.
          </p>
          <VideoDownloader />
        </section>
        ...
        <section className="w-full max-w-5xl py-12 md:py-16">
          <h2 className="text-3xl font-bold tracking-tight">
            Download YouTube Video in HD (Simple Steps)
          </h2>
            ...
            <Card>
              <CardContent className="flex flex-col items-center gap-4 p-6 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Open the YouTube video you want to download and copy its URL from the browser's address bar.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="flex flex-col items-center gap-4 p-6 text-center">
                ...
                <h3 className="text-lg font-semibold">Paste the URL and Fetch Qualities</h3>
                <p className="text-sm text-gray-600">
                  Paste the copied URL into the input box on this page and click "Get Video" to retrieve all available video qualities.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="flex flex-col items-center gap-4 p-6 text-center">
                ...
                <h3 className="text-lg font-semibold">Preview and Download Your Video</h3>
                <p className="text-sm text-gray-600">
                  Select the desired quality and click the download button.
                </p>
              </CardContent>
            </Card>
          </div>
